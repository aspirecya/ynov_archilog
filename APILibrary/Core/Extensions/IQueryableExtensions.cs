...
namespace APILibrary.Core.Extensions
{
    public static class IQueryableExtensions
    {
        ...
        public static IQueryable<dynamic> OrderByx<TModel>(this IQueryable<TModel> source, string orderByProperty,bool desc)
        {
            ...
            return source.Provider.CreateQuery<dynamic>(resultExpression);
        }
